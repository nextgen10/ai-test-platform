...
export default function AgentHubLanding() {
  ...
  const hero = isLight
    ? {
        ...
        glow: 'radial-gradient(ellipse 55% 50% at 78% 38%, rgba(7,105,166,0.04), transparent 68%)',
        outlineColor: '#1C1C1C',
    ...
    : {
        ...
        mask: 'radial-gradient(ellipse 80% 70% at 70% 40%, #000 30%, transparent 75%)',
        glow: 'radial-gradient(ellipse 55% 50% at 78% 38%, rgba(7,105,166,0.14), transparent 68%)',
        outlineColor: '#f9f9f7',
        outlineBorder: '#8e8d83',
