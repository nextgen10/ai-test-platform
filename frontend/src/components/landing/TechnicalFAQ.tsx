...
const FAQS = [
  ...
  {
    q: 'Can Qualaris test cases be exported to Jira, Xray, or TestRail?',
            ...
            >
              ...
              >
                <Typography variant="subtitle1" sx={{
                  fontWeight: isPanelExpanded ? 700 : 600,
                  fontSize: '0.95rem',
