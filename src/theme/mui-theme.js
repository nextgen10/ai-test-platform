// ../ai-test-platform/frontend/src/theme/index.ts
...
var pick = (p, mode) => mode === "light" ? p[0] : p[1];
var getTokens = (mode) => {
  const t = (k) => pick(T[k], mode);
  return {
    background: {
      primary: t("bgUi10"),
      // page / card ground
    ...
    border: {
      subtle: t("borderIllustrative"),
      // default divider / card edge
      light: t("borderLight"),
...
var ubsFontStack = 'system-ui, -apple-system, "Segoe UI", Roboto, Arial, Helvetica, sans-serif';
var ubsBrandFont = ubsFontStack;
var weight = { light: 300, book: 400, medium: 500 };
var typography = {
  ...
  overline: { fontSize: "0.6875rem", fontWeight: weight.medium, letterSpacing: "0.06em", textTransform: "uppercase" },
  button: { textTransform: "none", fontWeight: weight.medium, letterSpacing: 0 }
};
var radius = 1;
var shape = {
  none: 0,
...
var ubsTheme = getUnifiedTheme("light");
var nexusTheme = ubsTheme;
export {
  accents,
  band,
  colors,
