...
/**
 * The test-design pipeline as one wide diagram.
 *
 * Hand-placed on a 1440x550 canvas: the connector paths carry literal
 * coordinates that line up with each card's transform, so the nodes and the
 * streams between them cannot be reflowed independently.
 */
export default function RealtimeFlowDiagram() {
    ...
    return (
        <div className="w-full">
            <svg viewBox="0 0 1440 550" className="block h-auto w-full [&_text]:select-none">
                <defs>
                  ...
                  <marker id="arrow-red" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="6" markerHeight="6" orient="auto-start-reverse">
                    <path d="M 0 1 L 10 5 L 0 9 z" fill={BRAND} />
                  </marker>
                ...
                <path d="M 720 70 L 720 46" fill="none" stroke="#E60000" strokeWidth="2.2" strokeDasharray="4 4" markerEnd="url(#arrow-red)" />
                <circle r="4" fill="#E60000">
                ...
                <path d="M 820 108 L 930 108" fill="none" stroke={BRAND} strokeWidth="2.5" className="flow-line" markerEnd="url(#arrow-red)" />
                <circle r="4.5" fill={BRAND}>
                ...
                <path d="M 930 268 L 820 268" fill="none" stroke={BRAND} strokeWidth="2.5" className="flow-line" markerEnd="url(#arrow-red)" />
                <circle r="4.5" fill={BRAND}>
                ...
                <g transform="translate(630, 10)">
                  <rect width="180" height="34" rx="7" fill={isLight ? '#FBEAEA' : '#2a2a2a'} stroke="#E60000" strokeWidth="1.2" strokeDasharray="3 3" />
                  <text x="90" y="18" fill="#E60000" fontSize="10.5" fontWeight="500" textAnchor="middle">Rejected ➔ Run Halt</text>
                ...
                <g transform="translate(840, 88)">
                  <rect width="70" height="18" rx="4" fill={isLight ? '#f4f3ee' : '#1c1c1c'} stroke={alpha(BRAND, 0.4)} strokeWidth="1" />
                  <text x="35" y="12" fill={BRAND} fontSize="8" fontFamily="monospace" fontWeight="500" textAnchor="middle">approved</text>
                </g>

                {/* ROW 1: NODE 3 - Test Designer */}
                <g transform="translate(930, 70)">
                  <rect width="200" height="76" rx="10" fill={cardBg} stroke={BRAND} strokeWidth="1.8" />
                  <rect width="200" height="4" rx="2" fill={BRAND} />
                  <circle cx="28" cy="28" r="11" fill={alpha(BRAND, 0.15)} />
                  <text x="28" y="32" fill={BRAND} fontSize="11" fontWeight="500" textAnchor="middle">2</text>
                  <text x="50" y="32" fill={textColor} fontSize="13" fontWeight="500">Test Designer</text>
                  <text x="50" y="47" fill={BRAND} fontSize="9.5" fontWeight="500">5-Category Matrix</text>
                  <text x="20" y="65" fill={mutedColor} fontSize="9.5">Functional to Data</text>
                </g>

                {/* DESIGN JSON ARTIFACT */}
                <g transform="translate(1190, 178)">
                  <rect width="76" height="18" rx="4" fill={isLight ? '#f4f3ee' : '#1c1c1c'} stroke={alpha(BRAND, 0.4)} strokeWidth="1" />
                  <text x="38" y="12" fill={BRAND} fontSize="8" fontFamily="monospace" fontWeight="500" textAnchor="middle">design.json</text>
                </g>
                ...
                <g transform="translate(930, 230)">
                  ...
                  <rect width="200" height="4" rx="2" fill={BRAND} />
                  <circle cx="28" cy="28" r="11" fill={alpha(BRAND, 0.15)} />
                  <text x="28" y="32" fill={BRAND} fontSize="11" fontWeight="500" textAnchor="middle">3</text>
                  <text x="50" y="32" fill={textColor} fontSize="13" fontWeight="500">Test Generator</text>
                  <text x="50" y="47" fill={BRAND} fontSize="9.5" fontWeight="500">Actionable Steps</text>
                ...
                <g transform="translate(840, 248)">
                  <rect width="70" height="18" rx="4" fill={isLight ? '#f4f3ee' : '#1c1c1c'} stroke={alpha(BRAND, 0.4)} strokeWidth="1" />
                  <text x="35" y="12" fill={BRAND} fontSize="7.8" fontFamily="monospace" fontWeight="500" textAnchor="middle">draft.json</text>
                </g>
                ...
                <g transform="translate(620, 230)">
                  ...
                  <rect width="200" height="4" rx="2" fill={BRAND} />
                  <circle cx="28" cy="28" r="11" fill={alpha(BRAND, 0.15)} />
                  <text x="28" y="32" fill={BRAND} fontSize="11" fontWeight="500" textAnchor="middle">4</text>
                  <text x="50" y="32" fill={textColor} fontSize="13" fontWeight="500">Test Reviewer</text>
                  <text x="50" y="47" fill={BRAND} fontSize="9.5" fontWeight="500">Independent Critic</text>
